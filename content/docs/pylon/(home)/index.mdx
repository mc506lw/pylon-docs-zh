...
|    |    |
| :- | :- |
| ![Pylon 流体装置](img/fluid-setup.webp) | ![液压流体装置](img/hydraulic-fluid-setup.webp) 
| ![铜制流体储罐](img/looking-at-copper-fluid-tank.webp) | ![指南中的医疗包](img/medkit.webp) |
| ![放置铜管道](img/placing-pipes.webp) | ![使用液压磨石转向器](img/using-grindstone-turner.webp) |
| ![在 Pylon 指南中搜索物品](img/searching-items.webp) | ![净化塔配置](img/purification-tower-config.webp) |
| ![使用魔法祭坛](img/using-magic-altar.webp) | ![使用冶炼厂](img/using-smeltery.webp) |
| ![指南中的 Pylon 研究](img/looking-at-research.webp) | ![悬停于 Pylon 指南的研究包上](img/hovering-over-research-pack.webp) |
...
| 问题 | 回答                                                                                                                                                                                                                                                                                                                                                                 |
| -------- |------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **如何安装 Pylon？** | 看安装指南：[安装 Pylon](install)。注意，**Pylon 和 Rebar 还在实验阶段，别在正式服务器上用。** |                                                                                                                                                                         |

...
Pylon 是一个即将推出的 Minecraft Java 技术插件，会给原版玩法带来大量新内容：电力、柴油机器、新流体与管道、物流，还有更多！
...
- ⚙️ 你可以限制每个玩家或每个区块放置方块的数量。
- ⚙️ Pylon/Rebar 还会提供更多性能选项，比如降低流体管道的 tick 频率，或者减少特定机器的 tick 频率。
- ⚙️ 我们计划加入专用性能分析器，帮你准确定位哪些方块和物品最吃 CPU 和内存。
...
| 问题 | 回答                                                                                                                                                                                                                                                                                                                                                                 |
| -------- |------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **如何安装 Pylon？** | 看安装指南：[https://pylonmc.github.io/home/installing-pylon/](https://pylonmc.github.io/home/installing-pylon/)。注意，**Pylon 和 Rebar 还在实验阶段，别在正式服务器上用。** |                                                                                                                                                                         |
| **Rebar 会支持 Slimefun 附属组件吗？** | 不会。从 Slimefun 迁移到 Rebar 不轻松，建议附属开发者直接重写，更好地适配 Pylon 的进度和风格，而不是逐个迁移。 |                                                                                                                                                      |
| **Rebar/Pylon 将支持哪些版本？** | 每个版本的 Pylon/Rebar 只对应发布时的最新 Minecraft 版本。为了更新更快更省事，**每个 Pylon/Rebar 版本只支持一个 Minecraft 版本。** 想玩旧版 Minecraft 就用旧版 Pylon/Rebar。关键修复会向后移植。 |
| **Pylon/Rebar 能运行在哪些服务端软件上？** | 只支持 Paper 及其分支。未来可能支持 Folia。 |                                                                                                                                                                                                                                                                                                |
| **Pylon/Rebar 会支持基岩版（通过 Geyser）吗？** | 最终会支持，但优先级不高，是最后才加的功能之一。这类项目对接 Geyser 很麻烦，还会有一些怪问题。 |                                                                                                                                                                                          |
| **Pylon 什么时候能准备好？** | 看上面的「开发进度」表格。 |                                                                                                                                                                                                                                                                                                                          |
| **我该如何提交翻译？** | 插件变化太快，目前不接受翻译（提交了也很快过时）。准备好接受翻译时会发公告通知。 |                                                                                                                                                                   |

**还有其他问题？来 [Discord](https://discord.gg/4tMAnBAacW) 问我们吧。**
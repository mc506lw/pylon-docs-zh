...
function AddonListItem({ addon }: { addon: AddonData }) {
    return (
        <div className="group flex items-center gap-4 rounded-xl border border-fd-border bg-fd-card p-4 transition-all hover:border-fd-primary hover:shadow-md">
            <span className="text-2xl shrink-0">{addon.icon}</span>
            <div className="min-w-0 flex-1">
                <div className="flex items-center gap-2">
                    <h3 className="text-sm font-semibold text-fd-foreground truncate self-center">{addon.name}</h3>
                ...
                <p className="text-[13px] text-fd-muted-foreground truncate mt-0.5">{addon.description}</p>
            </div>
